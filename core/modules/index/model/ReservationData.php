...
class ReservationData {
	...
	public function add(){
		$sql = "insert into reservation (title,note,medic_id,date_at,time_at,pacient_id,created_at,estado) ";
		echo $sql .= "value (\"$this->title\",\"$this->note\",\"$this->medic_id\",\"$this->date_at\",\"$this->time_at\",$this->pacient_id,NOW(),$this->estado)";
