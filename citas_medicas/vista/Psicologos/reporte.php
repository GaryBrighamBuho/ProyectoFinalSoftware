...
$display_heading = array('coddoc' => '#', 'dnidoc' => 'DNI', 'nomdoc' => 'Nombres', 'apedoc' => 'Apellido', 'nombrees' => 'Especialidad', 'sexo' => 'Sexo', 'telefo' => 'Telefono', 'fechanaci' => 'Nacimiento', 'correo' => 'Correo', 'naciona' => 'Nacionalidad');

$result = mysqli_query($connString, "SELECT doctor.coddoc, doctor.dnidoc, doctor.nomdoc, doctor.apedoc, specialty.codespe, specialty.nombrees,doctor.sexo, doctor.telefo, doctor.fechanaci, doctor.correo, doctor.naciona, doctor.estado, doctor.fecha_create FROM doctor INNER JOIN specialty ON doctor.codespe = specialty.codespe") or die("database error:" . mysqli_error($connString));
